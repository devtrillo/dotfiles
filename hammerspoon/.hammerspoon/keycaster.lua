-- KeyPressShow.lua
-- From: https://kirbuchi.com/2016/10/26/playing-with-hammerspoon/
...
function showKeyPress(tap_event)
  ...
  hs.alert.show(modifiers .. character, {
...
KeypressShowKey = 'K'
k = hs.hotkey.modal.new(HYPER, KeypressShowKey)
function k:entered()
...
k:bind(HYPER, KeypressShowKey, function()
  key_tap:stop()
  k:exit()
end)
